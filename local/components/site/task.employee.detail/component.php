...
global $USER;
###
\Bitrix\Main\Loader::includeModule('site.task');
use SITE\TASK;
...
###
###Сохранение значений TASK###
if ($_REQUEST['savetask']) {
    if (TASK\TASKManager::SetTaskEmployee($arParams["USER_ID"],
        $_REQUEST['UF_PERIOD'], $_REQUEST['TASK'])
    ) {
